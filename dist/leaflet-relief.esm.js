...
const F = 40075017, h = 256, E = [0, 0, 0, 0], b = {
  available: [],
  idleSize: 5,
  idleTimeout: 3e4,
  // 30 seconds
  ...
  return `https://s3.amazonaws.com/elevation-tiles-prod/terrarium/${e}/${t}/${i}.png`;
}, M = function(e, t, i, l) {
  return e * 256 + t + i / 256 - 32768;
}, S = function(e, t, i, l) {
  ...
  let o = (t - i * n - l * a) / Math.sqrt(1 + n ** 2 + a ** 2);
  return o < 0 && (o = 0), o = Math.sqrt(o * 0.8 + 0.2), o;
}, L = function(e) {
  const t = Math.round(e * 255);
  return [t, t, t];
}, U = function(e, t) {
  const i = Math.PI - 2 * Math.PI * e / Math.pow(2, t), l = Math.atan(0.5 * (Math.exp(i) - Math.exp(-i))), n = F / (h * Math.pow(2, t)), a = Math.max(-Math.PI / 2, Math.min(Math.PI / 2, l));
  return Math.max(0.1, n * Math.cos(a));
}, z = function(e, t) {
  const i = C(e, t), l = y(e, t);
  return Math.atan(Math.sqrt(i * i + l * l)) * 180 / Math.PI;
}, p = (e, t, i) => {
  for (; e < 0; )
    e = e + 360;
  for (; e > 360; )
    e = e - 360;
  e = e / 60;
  const l = i * t, n = l * (1 - Math.abs(e % 2 - 1)), a = i - l;
  let o, s, r;
  return e >= 0 && e < 1 ? [o, s, r] = [l, n, 0] : e >= 1 && e < 2 ? [o, s, r] = [n, l, 0] : e >= 2 && e < 3 ? [o, s, r] = [0, l, n] : e >= 3 && e < 4 ? [o, s, r] = [0, n, l] : e >= 4 && e < 5 ? [o, s, r] = [n, 0, l] : [o, s, r] = [l, 0, n], [Math.round((o + a) * 255), Math.round((s + a) * 255), Math.round((r + a) * 255), 255];
}, T = [
  ...
  return function(t) {
    ...
    return p(i.h.max, 1, 1).slice(0, 3);
  };
  ...
  _fillTile: async function(e, t, i, l) {
    this._mode === "hillshade" ? this._fillHillshadeTile(e, t, i, l) : this._fillSlopeTile(e, t, i, l);
  },
  ...
  _getElevation: function(e, t, i) {
    const l = (i * h + t) * 4, n = e[l], a = e[l + 1], o = e[l + 2], s = e[l + 3];
    return this._elevationExtractor(n, a, o, s);
  },
  _getZ: function(e, t, i) {
    if (t <= 0 || i <= 0 || t >= h - 1 || i >= h - 1) {
      const l = Math.max(1, Math.min(t, h - 2)), n = Math.max(1, Math.min(i, h - 2));
      return this._getZ(e, l, n);
    }
    return [
      this._getElevation(e, t - 1, i - 1),
      this._getElevation(e, t - 1, i),
      this._getElevation(e, t - 1, i + 1),
      this._getElevation(e, t, i - 1),
      this._getElevation(e, t, i),
      this._getElevation(e, t, i + 1),
      this._getElevation(e, t + 1, i - 1),
      this._getElevation(e, t + 1, i),
      this._getElevation(e, t + 1, i + 1)
  ...
  _createHillshadeColor: function(e) {
    const t = R(e, this._hillshadeA1, this._hillshadeA2, this._hillshadeA3), [i, l, n] = this._hillshadeColorFunction(t);
    return [i, l, n, 255];
  },
  _fillHillshadeTile: function(e, t, i, l) {
    this._doFillTile(
      e,
      t,
  ...
  _createSlopeColor: function(e, t) {
    ...
    if (i < 0.5)
      return E;
    {
      const l = this._slopeColorFunction(i);
      return [l[0], l[1], l[2], 255];
    }
  },
  _fillSlopeTile: function(e, t, i, l) {
    const n = i.y, a = i.z, o = U(n, a);
    this._doFillTile(
      e,
      t,
  ...
  _tileUnloaded: function(e) {
    ...
    if (this._abortControllers.has(t)) {
      const i = this._abortControllers.get(t);
      i && (i.abort(), this._abortControllers.delete(t));
    }
  },
  createTile: function(e, t) {
    const i = e.x, l = e.y, n = e.z, a = `${n}/${i}/${l}`, o = document.createElement("canvas");
    ...
    const x = typeof this._elevationUrl == "function" ? this._elevationUrl(n, i, l) : this._elevationUrl.replace("{z}", n.toString()).replace("{x}", i.toString()).replace("{y}", l.toString());
    return (async () => {
      let u = null, _ = null, f = null;
      try {
        if (_ = b.acquire(), f = _.getContext("2d", { willReadFrequently: !0 }), !f)
        ...
        this._abortControllers.delete(a), u && u.close(), _ && b.release(_);
      }
    })(), o;
  },
